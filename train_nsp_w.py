...
parser.add_argument('--config_filename', '-cfn', type=str, default='sdd_nsp_w.yaml')
parser.add_argument('--save_file', '-sf', type=str, default='SDD_nsp_w.pt')
